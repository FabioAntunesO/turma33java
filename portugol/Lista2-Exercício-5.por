programa
{
	...
	funcao inicio()
	{
		 ...
		 */
		 ...
		 {
		 	escreva("O nível de poluição é de "+nvPoluicao+", e as empresas do 1º grupo serão intimadas a suspenderem suas atividades")
		 }
		 senao se(nvPoluicao >= 0.4 e nvPoluicao < 0.5 e gpEmpresa == 1 ou nvPoluicao >= 0.4 e nvPoluicao < 0.5 e gpEmpresa == 2)
		 {
		 	escreva("O nível de poluição é de "+nvPoluicao+", e as empresas do 1º e 2º grupo serão intimadas a suspenderem as atividades")
		 }
		 senao se(nvPoluicao >= 0.5 e gpEmpresa == 1 ou nvPoluicao >= 0.5 e gpEmpresa == 2 ou nvPoluicao >= 0.5 e gpEmpresa == 3)
		 {
		 	escreva("O nível de poluíção é de "+nvPoluicao+", todas as empresas devem suspender suas atividades")
		 }
		 senao se(gpEmpresa == 1 ou gpEmpresa == 2 ou gpEmpresa == 3)
		 {
		 	escreva("A empresa do "+gpEmpresa+"º grupo não será intimada a suspender suas atividades")
		 }
		 senao
		 {
